...
"""Halpe Full-Body plus coco wholebody (136 points) Human Detection Box dataset."""
import json
import os
...
from lib.pose.alphapose.alphapose.detector.apis import get_detector
from lib.pose.alphapose.alphapose.alphapose.models.builder import DATASET


@DATASET.register_module
class Halpe_coco_wholebody_136_det(data.Dataset):
    """ Halpe Full-Body plus coco wholebody (136 points) human detection box dataset.
